...
class Cache:
        ...
        async with conn.transaction():
            ...
            await conn.execute("""
                ...
                create table if not exists exprtest.eval_cache (
                  id serial primary key,
                  revision_id int references course_revision ( id ) not null,
                ...
                create table if not exists exprtest.eval_request (
                  ...
                  author int null,
                  data_id int references eval_data ( id ) not null,
                  cache_id int references eval_cache ( id ) null default null,
    ...
    async def get(self, course: Course, question: Optional[str],
        ...
        async with conn.transaction():
            ...
            # please note that there can be duplicate entries, however, these
            # should be equivalent if the evaluator is correct
            result = await conn.fetchrow("""
                select id, result, o.data as out, e.data as err from eval_cache
